...
\begin{enumerate}
    ...
    \item \textbf{Prediction Head} $\phi_P$: Generates $\Delta \Delta G$ from fused representations
\end{enumerate}
...
\begin{align}
    ...
    \Delta \Delta G &= \phi_P(\mathbf{h}_m)
\end{align}
...
% - Critical Analysis
% - Positioning
\subsection{Machine Learning for $\Delta Delta G$ Prediction}
