...
class ModelConfig:
    ...
    ddg_range: Tuple[float, float] = (-5.0, 5.0)
...
class ProtoBERTEmbeddings(nn.Module):
    ...
    def __init__(self, config: ModelConfig):
        ...
        self.token_type_embeddings = nn.Embedding(2, config.hidden_size)  # Only 2 types needed
...
class DDGDataset(Dataset):
    ...
    def __init__(self, num_samples: int, config: ModelConfig, seed: int = 42):
        ...
        for _ in range(num_samples):
            ...
            ddg_value = random.uniform(*self.ddg_range)
...
def main():
    """Complete example usage of ProtoBERT DDG prediction"""
